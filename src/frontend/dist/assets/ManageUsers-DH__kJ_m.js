import { j as jsxRuntimeExports, e as cn, o, r as reactExports, v as vt, d as Button, b as UserPlus, i as ShieldCheck, U as Users, a as Badge, k as getRoleBadgeColor, f as formatDate } from "./index-DrRtbove.js";
import { C as Card, c as CardContent, a as CardHeader, b as CardTitle } from "./card-C4j-Fijx.js";
import { I as Input } from "./input-BEIo1Vqp.js";
import { L as Label } from "./label-C0qo7enD.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-CEe-_UAa.js";
import { S as Skeleton } from "./skeleton-DN--iV-e.js";
import { k as useUsers, l as useCreateUser } from "./useBackend-DNXNmNW0.js";
import { X } from "./x-CfNeT1d-.js";
import { L as LoaderCircle } from "./loader-circle-CJlZMx7v.js";
...
const EMPTY_FORM = { name: "", email: "", role: "volunteer" };
function ManageUsers() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      ue.success(`User "${form.name}" added successfully.`);
      setForm(EMPTY_FORM);
      setShowForm(false);
    } catch {
      ue.error("Failed to create user. Please try again.");
    }
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-enter space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-semibold text-foreground", children: "Manage Users" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4", children: ROLE_OPTIONS.map(({ value, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-4 pb-4 flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: ROLE_ICONS[value] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-semibold text-foreground", children: roleCounts[value] ?? 0 }),
    ...
    showForm && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "user-email", children: "Email Address" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "user-email",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  ...
                  {
                    value: form.role,
                    onValueChange: (v2) => handleField("role", v2),
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "user-role", "data-ocid": "select-user-role", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select role" }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: ROLE_OPTIONS.map(({ value, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value, children: [
                        ROLE_ICONS[value],
                        " ",
                        label
                      ] }, value)) })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end mt-5 pt-4 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                type: "submit",
                ...
                children: createUser.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-border shadow-sm", "data-ocid": "users-table-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base font-semibold flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-4 w-4 text-primary" }),
        "All Users"
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6 space-y-3", "data-ocid": "users-loading", children: ["a", "b", "c", "d"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
      ...
      ] }, k)) }) : users.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-medium", children: "No users yet" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground/70 mt-1", children: 'Click "Add New User" to register the first team member.' })
          ]
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { "data-ocid": "users-table", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/40 hover:bg-muted/40", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-[40%]", children: "Name" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-[30%]", children: "Email" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-[15%]", children: "Role" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "w-[15%] text-right", children: "Joined" })
        ] }) }),
          ...
          TableRow,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center text-sm font-semibold text-primary flex-shrink-0", children: user.name.charAt(0).toUpperCase() }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground truncate", children: user.name })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-muted-foreground text-sm", children: user.email }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right text-sm text-muted-foreground", children: formatDate(user.createdAt) })
            ]
          },
          user.id
        )) })
