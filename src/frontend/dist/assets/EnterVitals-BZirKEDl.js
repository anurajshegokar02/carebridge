import { o, j as jsxRuntimeExports, A as Activity, H as Heart, d as Button, e as cn, h as formatVitalStatus } from "./index-DrRtbove.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-C4j-Fijx.js";
...
import { T as Textarea } from "./textarea-Ca4K8M26.js";
import { f as useCurrentUser, d as usePatients, g as useCreateRecord } from "./useBackend-DNXNmNW0.js";
...
function EnterVitals() {
  ...
  const [patientId, setPatientId] = o.useState("");
  const [checkDate, setCheckDate] = o.useState(getTodayISO());
  const [visitType, setVisitType] = o.useState("Home Visit");
  const [bpSystolic, setBpSystolic] = o.useState("");
  const [bpDiastolic, setBpDiastolic] = o.useState("");
  const [glucose, setGlucose] = o.useState("");
  const [heartRate, setHeartRate] = o.useState("");
  const [spo2, setSpo2] = o.useState("");
  const [temperature, setTemperature] = o.useState("");
  const [symptoms, setSymptoms] = o.useState("");
  const [success, setSuccess] = o.useState(false);
